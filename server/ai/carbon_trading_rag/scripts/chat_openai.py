...
def parse_args():
    parser = argparse.ArgumentParser(description="Chat with the carbon advisory RAG using OpenAI.")
    parser.add_argument(
        "--pdf",
        type=str,
        default=None,
        help="Optional local PDF path for temporary query-time reasoning.",
    )
...
def main() -> None:
    ...
    print("Carbon Advisory RAG (OpenAI)")
    ...
    while True:
        ...
        print("\nAssistant:\n")
        stream_openai_answer(settings, SYSTEM_PROMPT, user_prompt)
